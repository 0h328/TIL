...
1. 문제 풀이
   - 정해진 시간 동안 개인이 문제 풀이를 진행합니다.

2. 코드 리뷰
   - 리뷰 주제
     - 문제 접근 방식을 얘기
       - 어떤 부분에서 어떤 유형의 문제라고 생각했고 어떤 방식으로 문제를 풀어가면 되겠다고 판단했는지 
     - 문제를 풀면서 어려웠던 점이 무엇인지 질문
       - 문제 자체의 이해 
       - 입력 & 출력
       - 코드 구현 방식 
     - 문제에서 요구하는 개념에 대한 질문 및 다른 사람의 코드를 보며 궁금한 부분을 질문 &  '감탄'하며
...
4. 최종 리뷰가 끝나면 하나의 완성 코드를 만들어 노션에 작성
   - 최종적으로 발표 할 코드는 pycharm에서 볼 수 있도록 준비

5. 발표 과정에서 아래와 같은 도구를 활용 가능
...
- 코드 리뷰하며 나왔던 의견을 노션에 작성했나요?

☑ 팀 별로 최종 코드를 작성하여 노션에 작성했나요?

- 팀 별로 최종 코드에 상세하게 주석을 작성했나요?

☑ 팀 별 발표자 선정 및 발표 준비가 완료 되었나요?

- 발표자는 팀 코드를 온전하게 숙지했나요?
...
6. **(주의!💢) 최종적인 `Merge`는 담당 교수님이 진행 예정**
